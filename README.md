...
### 1️⃣4️⃣ AntiDDoSMitigator *(New)*  
Protects your server from connection flooding and DDoS attempts:  
- Detects abnormal connection patterns from clients.  
- Automatically blocks or throttles suspicious IPs.  
- Logs events and alerts staff if necessary.  
- Works silently in the background to maintain server stability.
